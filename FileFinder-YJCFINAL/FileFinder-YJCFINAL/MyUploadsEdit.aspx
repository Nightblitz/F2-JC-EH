<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MyUploadsEdit.aspx.cs" Inherits="FileFinder_YJCFINAL.MyUploadsEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="DescriptionTextBox" TextMode="multiline" Columns="20" Rows="3" class="form-control" placeholder="This is an awesome design!!" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator
        ...
        <div class="form-group">
            <asp:Button ID="DoneBtn" class="btn btn-primary" runat="server" OnClick="DoneBtn_Click" Text="Done" />
        </div>
    </fieldset>
</asp:Content>
