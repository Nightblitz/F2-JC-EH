...
namespace FileFinder_YJCFINAL
{
    ...
    {
        //private static string random = Cryptography.GetRandomString();
        //private static byte[] _salt = Encoding.ASCII.GetBytes(random);
        ...
        public static string EncryptStringAesSecretTextOfImage(string plainText, string sharedSecret)
        {
        ...
        public static string DecryptImageSecretTextAesIntoString(string cipherText, string sharedSecret)
        {
